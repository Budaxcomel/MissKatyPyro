...
TZ = environ.get("TZ", "Asia/Kuala_Lumpur")
...
SUDO = list(
    {
        ...
        for x in environ.get(
            "SUDO",
            "1358956715 5597816302",
        ).split()
    }
)
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "ImmanChannel")
...
FORWARD_TO_CHAT_ID = list(
    {int(x) for x in environ.get("FORWARD_TO_CHAT_ID", "-1001603431697").split()}
)
